...
import { EmailInUseError } from '@/domain/errors/index.errors.domain';
import {
  cleanup,
  fireEvent,
  render,
...
import {
  ...
  ValidationStub,
  SaveAccessTokenMock,
} from '@/presentation/test/index.mocks.presentation';
...
describe('SignUp Component', () => {
  ...
  test('Should enable submit botton if form is valid', () => {
    const { sut } = makeSut();
    Helper.populateField(sut, 'name');
    Helper.populateField(sut, 'email');
    Helper.populateField(sut, 'password');
